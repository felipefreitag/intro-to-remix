  ...
  return (
    <>
      <div className="mb-10 flex justify-between">
        ...
        <Link
          to={`/barks/new`}
          className="rounded-full bg-indigo-600 px-2.5 py-1 text-xs font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 enabled:hover:bg-indigo-800 disabled:opacity-50"
        >
          <svg
